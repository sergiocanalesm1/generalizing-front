...
<<<<<<< HEAD
const videoModelUrl = `${process.env.REACT_APP_MODELS_BUCKET}/glbs/video.glb`;
=======
import videoModelUrl from "./models/video.glb";
>>>>>>> 1f2d62f8ad4f5f3a1f2a0b97441b43aa350a1362

export default function Video(props) {
  const { nodes, materials } = useGLTF(videoModelUrl);
  const mesh = useRef();
